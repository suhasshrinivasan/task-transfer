...
dataloader_configs = OrderedDict(
    data_fname=[
        ...
        "/src/project/data/synthetic/haefner_2afc/haefner_model_2neuron_highdelta_task1_dataset.pkl",
        "/src/project/data/synthetic/haefner_2afc/haefner_model_2neuron_highdelta_task2_dataset.pkl",
        "/src/project/data/synthetic/haefner_2afc/haefner_model_1neuron_highdelta_task1_dataset.pkl",
        "/src/project/data/synthetic/haefner_2afc/haefner_model_1neuron_highdelta_task2_dataset.pkl",
        "/src/project/data/synthetic/haefner_2afc/haefner_model_4neuron_highdelta_task1_dataset.pkl",
        "/src/project/data/synthetic/haefner_2afc/haefner_model_4neuron_highdelta_task2_dataset.pkl",
    ],
    train_prop=[0.7],
    val_prop=[0.2],
)
