...
def train_vpost_prior(
    ...
    if model_args["posterior_dist"] == "gamma":
        amortization_fn = build_conc_rate_mlp(
            ...
            nonneg_transform=model_args["nonneg_transform"],
            clamp_pre_conc=model_args["clamp_pre_conc"],
            pre_conc_max=model_args["pre_conc_max"],
            clamp_pre_rate=model_args["clamp_pre_rate"],
            pre_rate_min=model_args["pre_rate_min"],
        )
